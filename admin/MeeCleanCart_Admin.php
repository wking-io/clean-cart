	 ...
	 public function cc_register_product_option_fields() {
		if ( function_exists( 'acf_add_local_field_group' ) ) :
			...
			$field_setup = array(
				...
				array(
					'key'      => 'field_product_thank_you_heading',
					'label'    => __( 'Product Thank You Heading', $this->plugin_name ),
					'name'     => 'product_thank_you_heading',
					'type'     => 'text',
					'placeholder' => 'Congrats!',
					'default_value' => 'Congrats!',
				),
				array(
					'key'      => 'field_product_thank_you_message',
					'label'    => __( 'Product Thank You Message', $this->plugin_name ),
					'name'     => 'product_thank_you_message',
					'type'     => 'text',
